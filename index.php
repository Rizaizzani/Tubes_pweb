                        ...
                        <div class="co-text">
                            <p>
                                Copyright &copy;<script>
                                    document.write(new Date().getFullYear()); | Repost by <a href='BETAH | KOST' title='BETAH|KOST' target='_blank'>StokCoding.com</a>

                                </script> All rights reserved | template <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#">BETAH|KOST</a>
